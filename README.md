...
db name: nd-proj1-sqldb
name: sqlsvradmin:ndpr0j1@
Config + storage; config db / basic
set connectivity: public
set firewall both to yes

to populate db:
- Go to resource page
- click query editor on the left; login and use sql editor to uload
- populate with provided scripts
...
go to Resource: containers
- create 'images' container
- set public access level to container level
...
Create resource -> Web app (Web apps are a type of app service)
nd-proj1-wapp
publish as code
runtime stack: python3
linux o/s
change sku and size; dev/test; free
